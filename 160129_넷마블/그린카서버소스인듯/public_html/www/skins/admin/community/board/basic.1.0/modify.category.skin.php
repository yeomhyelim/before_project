...
<table>
	<tr>
		<th>카테고리 사용</th>
		<td>
			<input type="radio" name="bi_category_use" value="Y"<?if($boardInfoAry['BI_CATEGORY_USE']=="Y"){echo " checked";}?>> 사용(모든사용자)
			<input type="radio" name="bi_category_use" value="A"<?if($boardInfoAry['BI_CATEGORY_USE']=="A"){echo " checked";}?>> 사용(관리자만)
