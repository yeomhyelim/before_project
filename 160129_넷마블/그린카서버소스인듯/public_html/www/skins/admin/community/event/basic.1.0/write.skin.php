	<table>
		...
		<tr>
			...
			<td>
				...
				<input type="checkbox" name="ub_func_webUse" value="Y" checked> 웹 페이지
				<input type="checkbox" name="ub_func_mobileUse" value="Y"> 모바일 페이지
			</td>
		</tr>
		<tr>
			<th>간략설명</th>
		...
		<tr>
			...
			<td>
				...
				<textarea style="width:100%;height:300px" id="ub_text" name="ub_text" title="<?=$_REQUEST['BOARD_INFO']['bi_datawrite_form']?>" alt="내용"></textarea>
			</td>
		</tr>
		<tr>
			<th>내용(모바일)</th>
			<td>
				<textarea style="width:100%;height:300px" id="ub_text_mobile" name="ub_text_mobile" title="<?=$_REQUEST['BOARD_INFO']['bi_datawrite_form']?>" alt="내용"></textarea>
			</td>
		</tr>
