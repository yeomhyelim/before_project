<?php
    /**
     * /home/shop_eng/www/modules/community/product/basic.1.0/community.product.controller.php
     * @author eumshop(thav@naver.com)
     * community product controller class (basic.1.0)
     * **/
...
// 	require_once MALL_HOME . "/classes/client/client.info.class.php";
	require_once MALL_HOME . "/classes/community/pointGive.func.class.php";
    ...
    class CommunityProductController extends CommunityController {
		 ...
		 * **/
		function getMessage() {
			echo "community product controller class (basic.1.0)";
		}
		...
		function getCountTotalEx() {
			...
			return $this->module->getProductMgrSelectEx("OP_COUNT", $param);
		}
