...
class MySQL {
	...
	function connectEx() {
		...
		$this->Conn =  mysql_connect($this->host, $this->user, $this->password) or exit(mysql_error());
	...
	function writeLog()
	{
		if ($this->error_number > 0)
		{
			...
			if(!file_exists("/home/wwwweb/public_html/www/logs/".$this->logFileName)) {
				$fp = fopen("/home/wwwweb/public_html/www/logs/".$this->logFileName,"w");
			} else {
				$fp = fopen("/home/wwwweb/public_html/www/logs/".$this->logFileName,"a");
			}
