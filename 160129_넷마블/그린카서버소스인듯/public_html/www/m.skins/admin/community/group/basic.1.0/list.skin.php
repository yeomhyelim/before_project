	...
	<table style="border-left:1px solid #D2D0D0">
		...
		<tr>
			...
			<td><?=$row['BG_FILE2']?></td>
			<td>
				<a href="javascript:goGroupModifyMove('<?=$row['BG_NO']?>');" class="btn_blue_sml" id="menu_auth_m" style=""><strong>수정</strong></a>
				<a href="javascript:goGroupDeleteAct('<?=$row['BG_NO']?>');"  class="btn_sml" id="menu_auth_d" style=""><strong>삭제</strong></a>
			</td>
		</tr>
		<? endwhile; ?>
		<? endif; ?>
