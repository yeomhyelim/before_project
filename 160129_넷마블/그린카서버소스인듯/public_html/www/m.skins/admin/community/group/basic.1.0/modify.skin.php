	...
	<a href="javascript:goGroupModifyAct()" class="btn_blue_big"  id="menu_auth_w" style=""><strong>그룹 수정</strong></a>
	<a href="javascript:goGroupListMove()" class="btn_blue_big"  id="menu_auth_w" style=""><strong>취소</strong></a>