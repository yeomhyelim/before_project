<?php
	...
	echo 'your token '.$deviceToken.'<br>';
	...
	// Payload 작성 (JSON)
	$body = array();
	$body['aps']['alert'] = array('body' => $message, 'actions' => array('key' => 'cc', 'value' => 'url'));
	if ($badge)
	...
	stream_context_set_option($ctx, 'ssl', 'local_cert', 'ios_key/apns-dev.pem'); 
