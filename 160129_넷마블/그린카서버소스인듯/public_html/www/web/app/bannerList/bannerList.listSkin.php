<?php
	/**
	 * eumshop app - bannerList - listSkin
	 *
	 * 배너 - 리스트 스킨
	 *
	 ...
	 * @since		Version 1.0
	 * @filesource	/www/web/app/bannerList/bannerList.listSkin.php
	 * @manual		menuType=app&mode=bannerList&skin=listSkin
	 * @history
	 *				2014.07.17 kim hee sung - 개발 완료
	 */
