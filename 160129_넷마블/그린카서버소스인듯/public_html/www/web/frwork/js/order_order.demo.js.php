...
//				intOrderTotalSPriceOrg				= data[0].O_TOT_SPRICE;
				...
				/* 주문내역 결제금액 */
				$(".totPayPrice").html("<span><?=$LNG_TRANS_CHAR['OW00026']?></span>: <strong class=\"priceOrange\">"+intOrderTotalSUsdPrice+"</strong><?=getCurMark2()?> (<?=$S_SITE_CUR_MARK1?><span>"+intOrderTotalSPrice+"</span>)");
	...
	function goOrderUsePointCheck()
	{
		...
		if ("<?=$S_POINT_USE2?>" == "N" && parseFloat(intOrderUsePoint) > 0)
		{
