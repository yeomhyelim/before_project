...
*/
	...
	function goSelectProdOptHtml(optNo,optVal,optPrice,optPrice2)
	{
		...
		strSelectProdOptHtml += "    <td class=\"optPrice\"><?=getCurMark()?> <strong id=\""+optNo+"_cartOptPriceMark\">"+optPrice+"</strong>";
	...
	function goSelectProdOptTotalHtml()
	{
		...
		if (intCartOptPriceTotal > 0)
		{
			...
			<?}else{?>
			strSelectProdOptTotalPriceHtml += "<?=$LNG_TRANS_CHAR['PW00042'];?>:<strong class=\"totalPriceTxt\"><?=getCurMark()?></strong>  <strong id=\"cartOptTotalPrice\" class=\"totalPrice\">"+intCartOptPriceTotal+"</strong><strong class=\"totalPriceTxt\">";
