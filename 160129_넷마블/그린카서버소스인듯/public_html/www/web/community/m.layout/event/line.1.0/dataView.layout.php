<?
	...
	$viewFile			= "{$_REQUEST['S_DOCUMENT_ROOT']}www/m.skins/user/community/event/basic.1.0/view.skin.php";
	$eventScriptFile	= "{$_REQUEST['S_DOCUMENT_ROOT']}{$_REQUEST['S_SHOP_HOME']}/html/event/eventScript.{$_REQUEST['ub_no']}.m.php";
