		...
		<div class="paymentInfo mt20">
			<?if ($orderRow[O_SETTLE] == "B" || ($req_tx == "pay" && $bSucc != "false")){?>
			<ul>
				...
				<tr>
					...
					<td>
						<ul class="priceInfo">
							...
							<li><span>부과세</span>: <strong><?=NUMBER_FORMAT($orderRow[O_TAX_PRICE])?>원</strong></li>
							<?}?>
	...
	<!-- (4) 결제내역 정보 -->
		...
		<div class="btnCenter">
			<a href="./"><img src="/himg/product/A0001/btn_payment_ok.gif"/></a>
			<a href="./?menuType=order&mode=buyList"><img src="../himg/product/A0001/btn_mypage_go.gif"/></a>
		</div>