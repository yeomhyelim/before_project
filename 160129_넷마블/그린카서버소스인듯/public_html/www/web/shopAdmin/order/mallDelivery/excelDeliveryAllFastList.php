...
<table border="1">
	<tr>
		...
		<th><?=getEuckrString("상품공급가"); //상품공급가?></th>
	...
	<tr id="shop_order_<?=getEuckrString($row['SO_NO']);?>">
		...
		<td><?=getEuckrString($row['O_B_ZIP']);?></td>
		<td><?=getEuckrString($row['O_B_ADDR1']);?> <?=getEuckrString($row['O_B_ADDR2']);?></td>

		<td><?=getEuckrString($orderPrice);?></td>
		<td><?=getEuckrString($deliveryprice);?></td>
		...
		<td><?=getEuckrString($deliveryComName);?></td>
		<td><?=getEuckrString($row['SO_DELIVERY_NUM']);?></td>
		<td><?=getEuckrString($settleStatus);?></td>
		<td><?=getEuckrString($deliveryStatus);?></td>
		<td><?=getEuckrString($orderStatus);?></td>
