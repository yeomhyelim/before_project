...
<!--
	...
	function goExcelDownload() {
		var data = new Array(5);
		data['mode']	= "excel";
		data['act']		= "excelVisitHostKeyWord";
		data['page']	= 1;
		C_getAddLocationUrl(data);
	}
	...
	function goHostKeyWordDetailList(no) {
		...
		var href			= "./?menuType=weblog&mode=popVisitHostKeyWord&serchStartDate="+serchStartDate+"&serchEndDate="+serchEndDate+"&no="+no;
...
<div class="tableList">
	<table>
		...
		<tr>
			<td style="text-align:left"><a href="javascript:goHostKeyWordDetailList('<?=$row['NO']?>')"><?=strHanCutUtf2($row['HOST'], 40)?></a></td>
