...
<!--
	...
	function goExcelDownload() {
		...
		data['mode']				= "excel";
		data['act']					= "excelOrderMonthStatics2";
...
<div id="contentArea">
	<div class="contentTop">
		<h2><?=$LNG_TRANS_CHAR["EW00092"] //월별주문통계?></h2>
		<div class="clr"></div>
	</div>
	...
	<div class="tableList mt30">
		<table>
			...
			<tr>
				<th rowspan="2"><?=$LNG_TRANS_CHAR["CW00013"] //월별?></th>
				...
				<!--<th colspan="2"><?=$S_ARY_SETTLE_STATUS["B"] //배송준비중?></th>//-->
