	<div class="tableList">
		<table style="border-left:1px solid #D2D0D0">
			...
			<tr>
				...
				<th><?=$LNG_TRANS_CHAR["OW00002"] //주문번호?>(주문일시/결제일시)</th>
				...
				<?if ($_REQUEST["searchOrderStatus"] == "D"){?><th><?="구매확정" //?><input type="checkbox" name="chkAll" value="Y" onclick="javascript:C_getCheckAll(this.checked)"/></th><?}?>
			</tr>
			<?if ($intTotal == 0){?>
			<tr>
			...
			<tr>
				...
				<?if ($S_MALL_TYPE != "R"){?><td <?=$strCartRowSpanHtml?>><?=$aryOrderCartShopList[$row['P_SHOP_NO']]['ST_NAME']?></td><?}?>
