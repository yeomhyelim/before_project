...
<div class="tableForm">
<? include "{$_REQUEST['S_DOCUMENT_ROOT']}www/skins/admin/community/board/basic.1.0/modify.basic.skin.php" ?>
</div>

<br>

<div class="button">
	<a class="btn_big" href="javascript:goBoardModifyBasicAct();" id="menu_auth_w" style=""><strong>설정 변경</strong></a>
