...
<div class="button">
	<a class="btn_big" href="javascript:goBoardModifyCategoryAct();" id="menu_auth_m" style="display:none"><strong>설정 변경</strong></a>
...
<div class="button">
	<?if(is_array($categoryListRow)): // 수정?>
	<a class="btn_big" href="javascript:goCategoryModifyActEvent();" id="menu_auth_m" style="display:none"><strong>카테고리 수정</strong></a>
	<a class="btn_big" href="javascript:goCategoryMoveEvent();"><strong>카테고리 취소</strong></a>
	<?else: // 신규등록?>
	<a class="btn_big" href="javascript:goCategoryWriteActEvent();" id="menu_auth_w" style="display:none"><strong>카테고리 등록</strong></a>
	<?endif;?>
</div>
