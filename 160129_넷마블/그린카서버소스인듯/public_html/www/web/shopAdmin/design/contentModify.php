...
<div class="tableForm">
	<table>
		...
		<tr>
			<th>내용</th>
			<td><textarea style="width:100%;height:250px;" name="cp_page_text" id="cp_page_text" title="higheditor_full"><?=$row[CP_PAGE_TEXT]?></textarea></td>
		</tr>
	</table>
	
	<div class="buttonWrap">
		<a class="btn_blue_big" href="javascript:goContentAct('contentModify');" id="menu_auth_w"><strong>추가 컨텐츠 저장</strong></a>
		<a class="btn_big" href="javascript:C_getMoveUrl('contentList','get','<?=$PHP_SELF?>');"><strong>목록</strong></a>
	</div>
</div><!-- tableForm -->
