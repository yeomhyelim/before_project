<?
	...
	$strDS_CODE			= ($strDS_CODE) ? $strDS_CODE : "PL0001";
?>
...
//		return;
		...
		doc.mode.value		= "act";
		doc.act.value		= "skinBestCodeModify";
...
//-->
	...
	<div class="layerPopWrap">
		...
		<div class="adminTabBtnWrap mt10">
			<a href="./?menuType=popup&mode=skinProdListDesign&ds_code=<?=$strDS_CODE?>&be_no=<?=$intBE_NO?>&ic_code=<?=$intIC_CODE?>&ic_type=<?=$strIC_TYPE?>&subPageCode=<?=$strSubPageCode?>" class="selected" style="margin-left:200px">디자인 선택</a>
			<a href="./?menuType=popup&mode=skinProdListDesignSet&ds_code=<?=$strDS_CODE?>&be_no=<?=$intBE_NO?>&ic_code=<?=$intIC_CODE?>&ic_type=<?=$strIC_TYPE?>&subPageCode=<?=$strSubPageCode?>">이미지 설정</a>
		</div>
