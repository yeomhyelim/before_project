<ul class="layoutType">
	...
	<li>
		...
		<?}else{?>
			<a href="./?menuType=layout&mode=pageDesignSave&pageDesign=MD" id="menu_auth_m"><img src="/shopAdmin/himg/design/layout_7.gif" onmouseover="layout_over(this)" onmouseout="layout_out(this)"/></a>
		<?}?>
	</li>
		<li>
		<?if($strPageDesign == "MB"){?>
