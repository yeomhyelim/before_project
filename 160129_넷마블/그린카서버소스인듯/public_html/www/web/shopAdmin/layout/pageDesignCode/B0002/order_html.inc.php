...
<body>
	...
	<!-- *********** Content Wrap ************  -->
			<div id="contentArea">
				<div id="contentWrap">
					<div id="leftArea">
					   <? include sprintf ( "%s%s/layout/html/order_left.inc.php", $S_DOCUMENT_ROOT, $S_SHOP_HOME  ); ?>
					</div>
					<div class="mainBodyWrap">
						<!-- *********** Content Wrap ************  -->
							<? include sprintf ( "%s%s/layout/html/order_body.inc.php", $S_DOCUMENT_ROOT, $S_SHOP_HOME ); ?>
						<!-- *********** Content Wrap ************  -->
					</div>
					<!-- 본문영역 -->
					<div class="clear"></div>
