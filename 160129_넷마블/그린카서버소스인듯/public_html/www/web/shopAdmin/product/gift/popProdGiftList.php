...
<?
	...
	$result = $productMgr->getProdGiftList($db);

	$linkPage  = "?menuType=$strMenuType&mode=$strMode&no=$intCG_NO&page=";
...
<!--
	...
	function goProdDelete()
	{
		...
		C_getAction("prodGiftProductDelete",'<?=$PHP_SELF?>');
	}
//-->
</script>
<div class="layerPopWrap">
	<div class="popTop">
		<h2>고객사은품 적용한 상품보기</h2>			
