<?
	...
	if ($strSearchProdCate){
		$strSearchProdCate1				= substr(0,3,$strSearchProdCate);
		$strSearchProdCate2				= (strlen($strSearchProdCate)>3) ? substr(0,6,$strSearchProdCate) : "";
		$strSearchProdCate3				= (strlen($strSearchProdCate)>6) ? substr(0,9,$strSearchProdCate) : "";
