...
<div id="contentArea">
	...
	<div class="tableForm">
		...
		<table>
			<tr>
				...
				<td colspan="3">
					<input type="text" <?=$nBox?>   style="width:90%;font-weight:bold;font-size:14px;" id="prodName" name="prodName" value="<?=htmlspecialchars($prodRow[P_NAME])?>"/>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<input type="text" <?=$nBox?>  style="width:150px;" id="prodOrigin" name="prodOrigin" value="<?=$prodRow[P_ORIGIN]?>"/>
			...
			<tr>
				...
				<td>
					<input type="text" <?=$nBox?>  style="width:150px;" id="prodOrder" name="prodOrder" value="<?=$prodRow[P_ORDER]?>"/>
				</td>
			</tr>
			<?if($a_admin_type == "A"):?>
			...
			<tr>
				...
				<td colspan="3">
					<input type="radio" name="prodListIconView" id="prodListIconView" value="1" <?=($prodRow[P_LIST_ICON_VIEW]=="1")?"checked":"";?>>계속보여주기
					<input type="radio" name="prodListIconView" id="prodListIconView" value="2" <?=($prodRow[P_LIST_ICON_VIEW]=="2")?"checked":"";?>>기간설정<br><br>
		...
		<table>
			<tr>
				...
				<td>
					...
					<?=$S_ARY_MONEY_ICON[$S_ST_LNG]["R"]?> 
					(할인율:<input type="text" <?=$nBox?>  style="width:40px;text-align:right;font-weight:bold;" id="prodDiscountRate" name="prodDiscountRate" maxlength="3" value="<?=$intProdDiscountRate?>"/>%)
					<span class="helpTxt">
			...
			<tr>
				...
				<td>
					...
					<input type="checkbox" name="prodPointNoUse" id="prodPointNoUse" value="Y" <?=($prodRow['P_POINT_NO_USE']=="Y")?"checked":"";?>>주문시포인트사용금지상품
				</td>
			</tr>
			<tr>
		...
		<div class="areaDivWrap topBorder">
			...
			<a href="javascript:goFormOpenEvent('prodOption')" id="prodOptionBtn" class="btn_sml_open"><span>열기</span></a>
			<div class="clear"></div>
		</div>
		<div id="prodOptionArea" style="display:none">
				<div style="padding:10px 0 5px;">
						...
						<input type="radio" id="prodOptType" name="prodOptType" value="3" <?=($prodRow[P_OPT]=="3")?"checked":"";?>/><?=$LNG_TRANS_CHAR["PW00053"] //다중가격분리형?>
				</div>
			<br>
	...
	<!-- 추가옵션관리 -->
	<?if ($S_MALL_TYPE == "R"){?>
		<div id="tableForm mt30">

		<!--  ****************  -->
		<div class="areaDivWrap">
		<h3><?=$LNG_TRANS_CHAR["PW00058"] //추가옵션관리?></h3>
			<a href="javascript:goFormOpenEvent('addOption')" id="addOptionBtn" class="btn_sml_open"><span>열기</span></a>
			<div class="clear"></div>
		</div>
	...
	<div class="tableForm">
		...
		<div class="areaDivWrap">
			...
			<a href="javascript:goFormOpenEvent('prodAdd')" id="prodAddBtn" class="btn_sml_open"><span>열기</span></a>
			<div class="clear"></div>
		</div>
	...
	<div class="tableForm">
		...
		<table id="tabProdImg2" <?=($intProdUrlImgCnt>0)?"style=\"display:none\"":"";?>>
			...
			<tr id="prodImgTrId_4" >
				...
				<td colspan="3">
					...
					<input type="checkbox" id="prodImgUrlYN" name="prodImgUrlYN" value="Y"  <?=$nBox?>  style="height:20px;" <?=($intProdUrlImgCnt>0)?"checked":"";?>/> 이미지 URL 사용하기
			...
			<tr id="productDetailImage_1">
				...
				<td colspan="3">
					기본 : <span><input type="file" id="prodImgBasic" name="prodImg7" value="" <?=$nBox?> style="height:20px;"/></span>
					...
					<?endif;?>
					확대 : <span><input type="file" id="prodImgExpend" name="prodImg18" value="" <?=$nBox?> style="height:20px;"/></span>
			...
			<tr id="productDetailImage_<?=$i-5?>">
				<th>상세이미지
				<td colspan="3">
					기본 : <span><input type="file" id="prodImgBasic" name="prodImg<?=$i?>" value="" <?=$nBox?> style="height:20px;"/></span>
					...
					<?endif;?>
					확대 : <span><input type="file" id="prodImgExpend" name="prodImg<?=$j?>" value="" <?=$nBox?> style="height:20px;"/></span>
		...
		<table id="tabProdImg3"  <?=($intProdUrlImgCnt==0)?"style=\"display:none\"":"";?>>
			...
			<tr id="productDetailUrlImage_1">
				...
				<td colspan="3">
					기본 : <span><input type="file" id="prodImgBasic" name="prodUrlImg7" value="<?=(is_array($aryProdImg[7]))?$aryProdImg[7][0]['PM_REAL_NAME']:"";?>" <?=$nBox?> style="width:350px;"/></span>
					<?if(is_array($aryProdImg[7])): // 기본이미지가 있을때 ?>
					<a class="btn_sml" id="btnProdImgView" href="javascript:C_openWindow('./?menuType=popup&mode=prodImageView&no=<?=$aryProdImg[7][0]['PM_NO']?>','img','500','500');"><strong>view</strong></a>
					<a class="btn_sml" id="btnProdImgDelete" href="javascript:goProdImgDel(<?=$aryProdImg[7][0]['PM_NO']?>);"><strong>X</strong></a>
					<?endif;?>
					확대 : <span><input type="file" id="prodImgExpend" name="prodUrlImg18" value="<?=(is_array($aryProdImg[18]))?$aryProdImg[18][0]['PM_REAL_NAME']:"";?>" <?=$nBox?> style="width:350px;"/></span>
					<?if(is_array($aryProdImg[18])): // 확대이미지가 있을때 ?>
					<a class="btn_sml" id="btnProdImgView" href="javascript:C_openWindow('./?menuType=popup&mode=prodImageView&no=<?=$aryProdImg[18][0]['PM_NO']?>','img','500','500');"><strong>view</strong></a>
					<a class="btn_sml" id="btnProdImgDelete" href="javascript:goProdImgDel(<?=$aryProdImg[18][0]['PM_NO']?>);"><strong>X</strong></a>
					<?endif;?>
			...
			<tr id="productDetailImage_<?=$i-5?>">
				<th>상세이미지
				<td colspan="3">
					기본 : <span><input type="file" id="prodImgBasic" name="prodUrlImg<?=$i?>" value="<?=(is_array($aryProdImg[$i]))?$aryProdImg[$i][0]['PM_REAL_NAME']:"";?>" <?=$nBox?> style="height:20px;"/></span>
					<?if(is_array($aryProdImg[$i])): // 기본이미지가 있을때 ?>
					<a class="btn_sml" id="btnProdImgView" href="javascript:C_openWindow('./?menuType=popup&mode=prodImageView&no=<?=$aryProdImg[$i][0]['PM_NO']?>','img','500','500');"><strong>view</strong></a>
					<a class="btn_sml" id="btnProdImgDelete" href="javascript:goProdImgDel(<?=$aryProdImg[$i][0]['PM_NO']?>);"><strong>X</strong></a>
					<?endif;?>
					확대 : <span><input type="file" id="prodImgExpend" name="prodUrlImg<?=$j?>" value="<?=(is_array($aryProdImg[$j]))?$aryProdImg[$j][0]['PM_REAL_NAME']:"";?>" <?=$nBox?> style="height:20px;"/></span>
					<?if(is_array($aryProdImg[$j])): // 확대이미지가 있을때 ?>
					<a class="btn_sml" id="btnProdImgView" href="javascript:C_openWindow('./?menuType=popup&mode=prodImageView&no=<?=$aryProdImg[$j][0]['PM_NO']?>','img','500','500');"><strong>view</strong></a>
					<a class="btn_sml" id="btnProdImgDelete" href="javascript:goProdImgDel(<?=$aryProdImg[$j][0]['PM_NO']?>);"><strong>X</strong></a>
					<?endif;?>
		...
		<table id="tabProdImg">
			...
			<?
				...
				for($z=7;$z<=17;$z++){
					...
					if (is_array($aryProdImg[$z]) && $aryProdImg[$z][0][PM_NO] > 0){
			?>
			<tr>
				<th><?=$LNG_TRANS_CHAR["PW00073"] //상세이미지?><?=$z-5?></th>
				<td style="width:380px;">
					<input type="file" id="prodImg<?=$z?>" name="prodImg<?=$z?>" value="" <?=$nBox?> style="height:20px;"/>
					<? if (  $strMode != "scrapingModify" ) { ?>
					<a class="btn_sml" href="javascript:C_openWindow('./?menuType=popup&mode=prodImageView&no=<?=$aryProdImg[$z][0][PM_NO]?>','img','500','500');"><strong>view</strong></a><a class="btn_sml" href="javascript:goProdImgDel(<?=$aryProdImg[$z][0][PM_NO]?>);"><strong>X</strong></a>
					<? } else { ?>
					<a class="btn_sml" href="javascript:C_openWindow('<?=$aryProdImg[$z][0][PM_REAL_NAME]?>','img','500','500');"><strong>view</strong></a><a class="btn_sml" href="javascript:goProdImgTempDel(<?=$aryProdImg[$z][0][PM_NO]?>);"><strong>X</strong></a>
					<input type="hidden" name="viewImg[]" id="viewImg[]" value="<?=$aryProdImg[$z][0][PM_REAL_NAME]?>"  />
					<? } ?>
				</td>
				<th><?=$LNG_TRANS_CHAR["PW00074"] //확대이미지?><?=$zz-16?></th>
				<td>
					<input type="file" id="prodImg<?=$zz?>" name="prodImg<?=$zz?>" value="" <?=$nBox?> style="height:20px;"/>
					<?
						if (is_array($aryProdImg[$zz]) && $aryProdImg[$zz][0][PM_NO] > 0){
						if ( $strMode != "scrapingModify" ) { 
					?>
							<a class="btn_sml" href="javascript:C_openWindow('./?menuType=popup&mode=prodImageView&no=<?=$aryProdImg[$zz][0][PM_NO]?>','img','500','500');"><strong>view</strong></a><a class="btn_sml" href="javascript:goProdImgDel(<?=$aryProdImg[$zz][0][PM_NO]?>);"><strong>X</strong></a>
					<? 	} else {		?>
					<?		}	}	?>
				</td>
			</tr>
...
--*/	?>
		...
		<table>
			...
			<tr>
				...
				<td>
					<textarea style="width:100%;height:250px;" name="prodWebText" id="prodWebText" title="higheditor_full"><?=$prodRow[P_WEB_TEXT]?></textarea>
					<div class="helpTxtGray">
		...
		<div class="areaDivWrap mt20">
			...
			<a href="javascript:goFormOpenEvent('mobileText')" id="mobileTextBtn" class="btn_sml_open"><span>열기</span></a>
			<div class="clear"></div>
		</div>
		<div id="mobileTextArea" style="display:none">
			<table style="width:100%;">
				...
				<tr>
					...
					<td colspan="3">
						<textarea style="width:100%;height:250px;" name="prodMobileText" id="prodMobileText" title="higheditor_full"><?=$prodRow[P_MOB_TEXT]?></textarea>
						<div class="helpTxtGray">
		...
		<div class="areaDivWrap">
			...
			<a href="javascript:goFormOpenEvent('prodHelpFile')" id="prodHelpFileBtn" class="btn_sml_open"><span>열기</span></a>
			<div class="clear"></div>
		</div>
		...
		<div class="areaDivWrap">
			...
			<a href="javascript:goFormOpenEvent('etcMemo')" id="etcMemoBtn" class="btn_sml_open"><span>열기</span></a>
			<div class="clear"></div>
		</div>
...
<div class="buttonWrap" style="margin:0px;padding-top:5px;padding-bottom:5px;border-top:5px solid #5e5e6d;position:Fixed;left:175px;bottom:0px;width:100%;background:#fff;">
	<a class="btn_blue_big" href="javascript:goProdAct('prodModify');" id="menu_auth_m" style="display:none"><strong><?=$LNG_TRANS_CHAR["CW00003"] //수정?></strong></a>
