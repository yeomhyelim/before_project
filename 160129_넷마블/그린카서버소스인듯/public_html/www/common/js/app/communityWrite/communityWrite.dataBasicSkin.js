	...
	// 시작
	if(typeof EditorJSLoader == 'object') {
...
//			goEumEditor2Ready(objConfig1, objConfig2);
	...
	// 글쓰기 취소
	function goCommunityWriteDataBasicSkinCancelMoveEvent() {
	...
	// 글쓰기 액션
	function goCommunityWriteDataBasicSkinWriteActEvent(strAppID) {
	...
	// 글쓰기 폼 체크
	function goCommunityWriteDataBasicSkinWriteFormCheck(strAppID) {
	...
	// 첨부파일 폼 토글
	function goCommunityWriteDataBasicSkinAtcFormToggleEvent(strAppID) {
	...
	// 첨부파일 업로드
	function goCommunityWriteDataBasicSkinAtcWriteActEvent(strAppID) {
		...
		objTarget.ajaxForm({
			...
			success		 :  function(data) {
				...
				if(data['__STATE__'] == "SUCCESS") {
					console.log(data);
					goCommunityWriteDataBasicSkinAtcFileDrawEvent(strAppID, data);
					goCommunityWriteDataBasicSkinAtcFormToggleEvent(strAppID);
	...
	// 첨부파일 업로드 이후 그리기
	function goCommunityWriteDataBasicSkinAtcFileDrawEvent(strAppID, data) {
	...
	// 첨부파일 삭제
	function goCommunityWriteDataBasicSkinAtcDeleteActEvent(strAppID, intNo) {
