...
<title>*** KSNET WebHost Sample [PHP] ***</title>
...
<form name=KSPayWeb action = "./kspay_wh_result.php" method=post>
<table width="560" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td height="50" align="right" background="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/bg_top.gif" class="txt_pd1">KSNET WebHost Sample [PHP]</td>
	</tr>
	<tr>
					...
					<td width="505" align="center">
						<table border='0' cellpadding='0' cellspacing='0' width='500' align='center'>
							<tr>
								...
								<img src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_tit3.gif" width="30" height="30" align="absmiddle"> <strong>고객에게 보여지지 않아야 하는 설정값 항목<strong>
								</td>
							</tr>
							<tr>
								<td align="center">
									<table width="400" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											<td width="110"><img src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif" width="11" height="11" align="absmiddle"> 상점아이디</td> 
										...
										<tr>
											<td width="110"><img src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_right.gif" width="11" height="11" align="absmiddle"> 주문번호</td> 
							...
							<tr>
								...
								<img src="http://kspay.ksnet.to/store/KSPayFlashV1.3/mall/imgs/ico_tit4.gif" width="30" height="30" align="absmiddle"> <strong>고객에게 보여주는 항목</strong></td>
							</tr>
							<tr>
								<td align="center">
									<table width="400" border="0" cellspacing="0" cellpadding="0">
