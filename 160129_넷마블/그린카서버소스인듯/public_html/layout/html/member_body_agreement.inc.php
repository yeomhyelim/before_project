<div id="contentWrap">
	<div class="subNavWrap">
		...
		<ul class="cusNavList">
			...
			<li><a href="./?menuType=member&mode=agreement" class="selected">이용약관</a></li>
		...
		<div class="prodTopAreaView">
			...
			<div class="locationWrap">
				<ul>
					...
					<li class="end"><?= $LNG_TRANS_CHAR["MW00041"]; //이용약관 ?></li>
				</ul>
			</div>
			<div class="clr"></div>
		</div>
		<div class="clr"></div>
		<div class="boxGray"><? include "{$S_DOCUMENT_ROOT}{$S_SHOP_HOME}/conf/policy.use.{$S_SITE_LNG_PATH}.inc.php"; ?></div>
