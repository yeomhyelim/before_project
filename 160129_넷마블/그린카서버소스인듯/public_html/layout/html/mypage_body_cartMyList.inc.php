<div class="mypageWrap">
	...
	<div class="mypageContentsWrap">
		<div class="prodTopAreaView">
			<h2><?=$LNG_TRANS_CHAR["CW00040"]?></h2>
			<div class="locationWrap">
				<ul>
					<li class="home">H</li>
					<li><?=$LNG_TRANS_CHAR["MW00048"]//마이페이지?></li>
					<li class="end"><?=$LNG_TRANS_CHAR["CW00040"]?></li>
				</ul>
			</div>
			<div class="clr"></div>
		</div>
		<div class="clr"></div>
		<div class="myT30"><? include "{$S_DOCUMENT_ROOT}www/web/mypage/mypage_cartMyList.inc.php"; ?></div>
	</div>
	<div class="clear"></div>
</div>