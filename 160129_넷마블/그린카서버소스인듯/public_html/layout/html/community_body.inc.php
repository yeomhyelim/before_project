<div id="contentWrap">
	...
	<div class="rightContentWrap bbsListArea">
		...
		<div class="bbsContentWrap">
			<?php include $includeFile;?>
		</div>
		<?// include MALL_SHOP . "/layout/html/community/{$S_SITE_LNG_PATH}/board.{$_REQUEST['b_code']}.script.php"; ?>
	</div>
	<div class="clr"></div>
</div>