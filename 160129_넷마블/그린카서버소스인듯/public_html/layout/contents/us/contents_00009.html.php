<div id="contentWrap">
	...
	<div class="rightContentWrap">
		...
		<div class="b_imgBox">
			<img src="/upload/images/img_shopInfo_1_us.jpg">

			<div class="infoImgBox">
				<div class="leftDiv"><img src="/upload/images/img_shopInfo_2_us.jpg"></div>
				<div class="rightDiv"><img src="/upload/images/img_shopInfo_3_us.jpg"><a href="./?menuType=shop&amp;mode=shopApplyReg" class="btnShopOk"><?= $LNG_TRANS_CHAR["CW00127"]; //입점신청하기 ?>></a></div>
				<div class="clr"></div>
			</div>
		</div>
