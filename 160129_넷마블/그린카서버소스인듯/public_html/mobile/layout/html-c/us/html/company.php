...
<div class="contentBodyWrap">
	...
	<div class="tabBtnWrap">
		<a class="btn1 on" href="#;" onclick="C_getTabChange('tab','1')" id="btn-tab1" style="font-size:12px"><?=$LNG_TRANS_CHAR["CW00110"]//136601 소개?></a>
		<a class="btn2" href="#;" onclick="C_getTabChange('tab','2')" id="btn-tab2" style="font-size:12px">Management Philosophy</a>
	</div>
