		...
		<div class="prodTopAreaView">
			...
			<div class="locationWrap">
				<ul>
					<li class="home">H</li>
					<li>고객센터</li>
					<li class="end">입점 및 제휴안내</li>
				</ul>
			</div>
			<div class="clr"></div>
		</div>
		<div class="b_imgBox">
			<img src="/upload/images/img_shopInfo_1_kr.jpg">

			<div class="infoImgBox">
				<div class="leftDiv"><img src="/upload/images/img_shopInfo_2_kr.jpg"></div>
				<div class="rightDiv"><img src="/upload/images/img_shopInfo_3_kr.jpg"><a href="./?menuType=shop&amp;mode=shopApplyReg" class="btnShopOk">입점신청하기 ></a></div>
				<div class="clr"></div>
			</div>
		</div>
