...
<div class="mainContentList">
	<div class="mainBannerArea">
		<div class="mainBannerWrap">
			<div class="leftBannerBox">
				<img src="/upload/images/banner_main1.jpg"/>
			</div>
			<div class="rightBannerBox">
				<ul>
					<li><img src="/upload/images/banner_mainList2.jpg" onclick="javascript:mainTabImgChange(0);"/></li>
					<li><img src="/upload/images/banner_mainList3.jpg" onclick="javascript:mainTabImgChange(1);"/></li>
					<li><img src="/upload/images/banner_mainList4.jpg" onclick="javascript:mainTabImgChange(2);"/></li>
				</ul>
				<div class="clr"></div>
			</div>
			<div class="clr"></div>
	...
	<div class="mainBestWrap">
		<div class="bestProdListWrap">
			<h3 class="icoTit">NEW <span>PRODUCT</span></h3>
