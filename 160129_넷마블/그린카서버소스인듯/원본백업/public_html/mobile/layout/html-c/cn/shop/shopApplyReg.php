			...
			<table>
				...
				<tr>							
					...
					<div class="krView" style="display:<?=($S_SITE_LNG == 'KR') ? '' : 'none';?>">
						...
						<input type="text" <?=$nBox?>  style="width:100px;" id="com_fax" name="com_fax" value="<?=$strComFax?>"  maxlength=""/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td class="number">
						...
						<div class="otherView" style="display:<?=($S_SITE_LNG != 'KR') ? '' : 'none';?>">
						<input type="text" <?=$nBox?>  style="width:50px;" id="com_phone" name="com_phone" value="<?=$strComPhone?>"  maxlength=""/>
						</div>
					</td>
				</tr>
