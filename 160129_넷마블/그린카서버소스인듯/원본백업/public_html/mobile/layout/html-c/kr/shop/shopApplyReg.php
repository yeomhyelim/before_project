					...
					<td>
						<p class="number">
							...
							<div class="divAddr1" <?=($S_SITE_LNG!="KR")?"style=\"display:none\"":"";?>>
								<input type="text" <?=$nBox?>  style="" id="com_addr2" name="com_addr2" value="" class="mt5"/>
							</div>
							...
							<div id="layer" style="display:none;width:100%;height:100%;top:0px;left:0px;position:absolute;overflow-y:scroll;-webkit-overflow-scrolling:touch;">
								<h2><?=$LNG_TRANS_CHAR["SW00014"] //우편번호?></h2>
		...
		<div class="tableFormWrap" style="margin-top:30px;display:none" id="detailInput1">
			...
			<div class="tableBox">
				<table>
					...
					<tr>
						<th><strong class="redTxt">*</strong> <?= $LNG_TRANS_CHAR["SW00042"]; //직원수 ?> (<?= $LNG_TRANS_CHAR["SW00058"]; //명 ?>)</th>
						<td><input type="text" id="com_number" name="com_number" class="nbox" /></td>
					</tr>
					<tr>
					...
					<tr>
						<th><strong class="redTxt">*</strong> <?= $LNG_TRANS_CHAR["SW00046"]; //주요 유통 시장 ?> <br /> (%)</th>
						<td>
							<ul class="infoTable">
								<?
					...
					<tr>
						<th><strong class="redTxt">*</strong> <?= $LNG_TRANS_CHAR["SW00049"]; //R&D직원수 ?>(<?= $LNG_TRANS_CHAR["SW00058"]; //명 ?>)</th>
						<td><input type="text" id="com_rd" name="com_rd" class="nbox"/></td>
					</tr>
					<tr>
