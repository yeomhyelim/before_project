<?php 	
	...
	$intWList 			= ${"S_SUB_PRODLIST_IMG_VIEW_W_".$i};
	$intHList			= ${"S_SUB_PRODLIST_IMG_VIEW_H_".$i};
	$intWSize 			= ${"S_SUB_PRODLIST_IMG_SIZE_W_".$i};
	$intHSize			= ${"S_SUB_PRODLIST_IMG_SIZE_H_".$i};
						...
						<td <?= $style ?>>
							<div class="prodWrap" <?= $style ?> >
								...
								<ul <?= $style ?>>
									...
									<li class="priceOrg"><?=getCurMark()?> <s><?=getCurToPrice($row[P_CONSUMER_PRICE])?></s></li>
