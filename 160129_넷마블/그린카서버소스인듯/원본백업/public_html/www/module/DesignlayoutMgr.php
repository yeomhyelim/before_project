...
class DesignlayoutMgr
{
	...
	function getDesignlayoutView($db)
	{
		...
		$query .= "WHERE DL_NO  IS NOT NULL										";
//		$query .= "WHERE DL_NO=".$this->getDL_NO()."							";
	...
	/********************************** Insert **********************************/
	function getDesignlayoutInsert($db)
	{
	...
	/********************************** Insert **********************************/
	function getDesignlayoutDelete($db)
	{
		$query = "CALL SP_DESIGN_LAYOUT_D (?);";
		$param[]  = $this->getDL_NO();
