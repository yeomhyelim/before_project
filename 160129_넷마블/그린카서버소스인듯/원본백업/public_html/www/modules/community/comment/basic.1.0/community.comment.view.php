<?php
    /**
     * /home/shop_eng/www/modules/community/comment/basic.1.0/community.comment.view.php
     * @author eumshop(thav@naver.com)
     * community comment view class (basic.1.0)
	 * $dataView = new CommunityCommentView($db, $_REQUEST);
     * **/
    ...
    class CommunityCommentView extends CommunityView {
		 ...
		 * **/
		function getMessage() {
			echo "community comment view class (basic.1.0)";
		}
...
//			$listResult				= parent::getListNoPageEx("OP_LIST", $param);
		...
		function getListProcess() {
			...
			## STEP 1.
			## 데이터 리스트
			$this->field['result']['CommentMgr']	= $this->getListEx();
...
//			echo $this->db->query;
			...
			$pageParam['link']			= "./?menuType={$this->field['menuType']}&mode={$this->field['mode']}&b_code={$this->field['b_code']}&ub_no={$this->field['ub_no']}&myTarget={$this->field['myTarget']}&page=";
		...
		function getEventTypeSelect() {
			return $this->module->getCommentMgrCmEventTypeSelect(); 
		}
		...
		function getPointCount() {
			return $this->module->getCommentMgrPointCount();
		}
		...
		function getCouponCount() {
			return $this->module->getCommentMgrCouponCount();
		}
