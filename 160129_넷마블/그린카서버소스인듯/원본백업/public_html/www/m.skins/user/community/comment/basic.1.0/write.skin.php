...
?>
	...
	<div id="commentWrite" alt="코멘트쓰기">
		...
		이름 : <input type="text" name="cm_name" id="cm_name" value="" alt="이름" check="write"/>
		비밀번호 : <input type="password" name="cm_pass" id="cm_pass" value="" alt="비밀번호" check="write"/>
		<? endif; ?>
		...
		<?else:?>
			...
			<div class="clear"></div>
			<?else:?>
			<textarea id="cm_text" name="cm_text" alt="내용" check="write" class="commentWriteForm" onClick="goLoginPageMoveEvent('N')" readOnly></textarea>
			<a id="commentWriteOk" href="javascript:goLoginPageMoveEvent('N')" class="btnWriteComment"><strong>등록</strong></a>
			<div class="clear"></div>
			<?endif;?>
		<?endif;?>
	</div>
