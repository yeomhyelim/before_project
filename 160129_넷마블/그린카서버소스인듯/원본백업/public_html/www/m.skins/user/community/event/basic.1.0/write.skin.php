	<table>
		<tr>
			...
			<td>
				...
				<? else:				// 비회원 ?>
				<input type="text" <?=$nBox?>  style="width:300px;" id="ub_name" name="ub_name"  alt="작성자" check="Y" maxlength="10"/>
				<? endif; ?>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<th>기간</th>
			<td>
				<input type="text" name="ub_event_s_dt" id="ub_event_s_dt" style="width:100px;" value="" maxlength="10"> 부터
				<input type="text" name="ub_event_e_dt" id="ub_event_e_dt" style="width:100px;" value="" maxlength="10"> 까지
			</td>
		</tr>
		...
		<tr>
			<th>제목</th>
			<td>
				<input type="text" <?=$nBox?>  style="width:100%;" id="ub_title" name="ub_title" alt="제목" check="Y" maxlength="50"/>
			</td>
		</tr>
		<tr>
			<th>간략설명</th>
		...
		<tr>
			<td colspan="2"><textarea style="width:100%;height:300px" id="ub_text" name="ub_text" title="<?=$_REQUEST['BOARD_INFO']['bi_datawrite_form']?>" alt="내용" check="Y"></textarea></td>
		</tr>
