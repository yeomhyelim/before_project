...
?>
	<table id="data_<?=$_REQUEST['BOARD_INFO']['b_code']?>">
		...
		<!-- 리스트 폼 -->
		<textarea id="dataList_form" style="display:none;" alt="리스트">
		<tr id="">
			<!--td><input type="checkbox"></td-->
			<!--번호--><td id="list_num"></td>
			<!--상품이미지--><td id="prodImage">상품</td>
			<!--제목--><td style="text-align:left;padding-left:10px;">
						<a href="" id="dataViewShow">
						<span id="ub_title"></span>
						<span id="my_write">[내글]</span>
						</a>
					   </td>
			<!--작성자(성명)--><td id="ub_name"></td>
			<!--작성자(아이디)--><td id="ub_m_id"></td>
			<!--작성일--><td id="ub_reg_dt"></td>
			<!--조회수--><td id="ub_read"></td>
		</tr>
		<tr>
			<td colspan="7" style="text-align:left;padding-left:50px;"></td>
		</tr>
		</textarea>	 
		<!-- 뷰 폼 -->
