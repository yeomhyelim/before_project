	<table>
		...
		<tr>
			...
			<td><a href="javascript:goBoardModifyMoveEvent('<?=$row['B_CODE']?>')" class="btn_blue_sml" id="menu_auth_m"><strong>기능설정</strong></a>
				<a href="javascript:goBoardStopAct('<?=$row['B_CODE']?>')" class="btn_sml" id="menu_auth_m"><strong>운영정지</strong></a></td>
		</tr>
		<? endwhile; 
		   endif; ?>
	</table>
