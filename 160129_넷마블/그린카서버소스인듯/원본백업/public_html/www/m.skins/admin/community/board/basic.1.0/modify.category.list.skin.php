	<table style="border-left:1px solid #D2D0D0">
		...
		<tr>
			...
			<td><?=$row['BC_SORT']?></td>
			<td><a href="javascript:goCategoryModifyMoveEvent('<?=$row['BC_NO']?>')" class="btn_blue_sml" id="menu_auth_m" style=""><strong>수정</strong></a>
				<a href="javascript:goCategoryDeleteActEvent('<?=$row['BC_NO']?>')" class="btn_blue_sml" id="menu_auth_m" style=""><strong>삭제</strong></a></td>
		</tr>
		<? endwhile; 
		   endif; ?>
	</table>
