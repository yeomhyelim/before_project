...
<div class="tableForm">
	...
	<table>
		<tr>
			<th>스크립트</th>
			<td>
				<textarea name="bi_datascript_widget_data" id="bi_datascript_widget_data" style="width:100%;height:500px"><?include "{$_REQUEST['S_DOCUMENT_ROOT']}{$_REQUEST['S_SHOP_HOME']}/layout/html/community/widget.{$_REQUEST['b_code']}.script.tag.php"?></textarea>				
			</td>
		</tr>
	</table>
</div>
