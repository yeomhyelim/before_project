...
# also use your own API username that you created on PayPal뭩 sandbox
# or the PayPal live site
*/
//for 3-token -> API_USERNAME,API_PASSWORD,API_SIGNATURE  are needed


define('API_USERNAME', $SITE_API_USERNAME);
//
...
define('API_PASSWORD', $SITE_API_PASSWORD);

/**
# API_Signature:The Signature associated with the API user. which is generated by paypal.
*/

define('API_SIGNATURE', $SITE_API_SIGNATURE);

/**
# Endpoint: this is the server URL which you have to connect for submitting your API request.
*/

define('API_ENDPOINT', $SITE_API_ENDPOINT);
...
/* Define the PayPal URL. This is the URL that the buyer is
   ...
   */
define('PAYPAL_URL', $SITE_PAYPAL_URL);
