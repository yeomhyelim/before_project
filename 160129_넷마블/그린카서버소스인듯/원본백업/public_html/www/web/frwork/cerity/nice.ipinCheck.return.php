...
<head>
	...
	<script language='javascript'>
		function fnLoad()
		{
			...
			parent.opener.parent.document.vnoform.menuType.value = "member";
			parent.opener.parent.document.vnoform.mode.value = "joinForm";
			parent.opener.parent.document.vnoform.action = "./index.php";
