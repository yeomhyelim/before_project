...
*/		
	...
	function goSelectProdOptHtml(optNo,optVal,optPrice,optPrice2)
	{
		...
		strSelectProdOptHtml += "    <th class=\"optTit\">"+optVal+"</th>";
		...
		strSelectProdOptHtml += "                <a href=\"javascript:goProdViewQtyChange("+optNo+",'up',1);\"><span class=\"plus\">+</span></a>";
		strSelectProdOptHtml += "                <a href=\"javascript:goProdViewQtyChange("+optNo+",'down',1);\"><span class=\"down\">-</span></a>";
		strSelectProdOptHtml += "            </li>";
						...
						{	
							...
							$('div[id^="divCartOptAttr_"]').each(function(i){
								...
								if (strCartDivId == $(this).attr("id") && intCartAddOptIsCnt == 0)
								{
									...
									strSelectProdOptHtml += "    <th class=\"optTit\">"+strPAO_TEXT+"</th>";
									strSelectProdOptHtml += "    <td class=\"optCnt\">";
