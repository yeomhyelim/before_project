<div class="tableForm">
	<? include "{$_REQUEST['S_DOCUMENT_ROOT']}www/skins/user/community/product/qna.1.0/view.skin.php" ?>
</div>


<div class="btnRight">
	<?if($_REQUEST['buttonLock']['dataAnswer']=="X"): //답변권한, 상품 QNA에서는 사용자 페이지에서 답변 사용 안함. ?>
	...
	<?if($_REQUEST['buttonLock']['dataDelete']): //삭제권한 ?>
