...
<div class="tableList" alt="리스트">
	...
	<? include "{$_REQUEST['S_DOCUMENT_ROOT']}www/skins/user/community/data/gallery.1.0/list.skin.php" ?>
</div>

<?if($_REQUEST['buttonLock']['dataWrite']==1): //글쓰기권한 ?>
<div class="btnRight">
	<a class="btn_board_write" href="javascript:goDataWriteMove();" id="menu_auth_w"><strong>글쓰기</strong></a>
</div>
