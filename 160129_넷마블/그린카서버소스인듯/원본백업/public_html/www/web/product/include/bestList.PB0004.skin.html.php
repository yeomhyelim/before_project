...
<div class="bestProdListWrap<?php echo $no?>">
	...
	<div class="prodListWrap">
		<?php for($i=0;$i<$intHList;$i++):?>
			...
			<?php if($row):?>
				<div class="prodInfoWrap_<?php echo $j;?>">
					...
					<div class="prodInfoSum">
						<ul>
							...
							<?php if($strShow5 == "Y"):?>
								...
								<li class="priceSaleUsd"><span class="usdPrice"><?php echo $strTextPriceUsd // USD 달러?></span> <span class="price">(<?php echo $strTextPrice; // 가격?>)</span></li>
								<?php else:?>
