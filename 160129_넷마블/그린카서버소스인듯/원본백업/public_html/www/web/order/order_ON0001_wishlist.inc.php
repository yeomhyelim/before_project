		...
		<div class="cartListWrapBig mt40">
			<div class="cartTabWrap">
				<span class="tabBtn1"><?=$LNG_TRANS_CHAR["CW0005"] //담아둔 상품?>(<?=NUMBER_FORMAT($intWishTotal)?>)</span>
					...
					<tr>
						...
						<td>
							<dl>
								...
								<dd>
									<a href="javascript:goQtyUpMinus('wish',1,<?=$wishRow[PW_NO]?>);"><img src="/himg/product/A0001/<?=$S_SITE_LNG_PATH?>/btn_cart_cnt_up.gif"/></a>
									<a href="javascript:goQtyUpMinus('wish',-1,<?=$wishRow[PW_NO]?>);"><img src="/himg/product/A0001/<?=$S_SITE_LNG_PATH?>/btn_cart_cnt_down.gif"/></a>
								</dd>
								<dd><a href="javascript:goQtyUpdate('wish',<?=$wishRow[PW_NO]?>);"><img src="/himg/product/A0001/<?=$S_SITE_LNG_PATH?>/btn_cart_cnt_modify.gif"/></a></dd> 
							</dl>
							
						</td>
						<td><strong class="priceOrange"><?=getCurMark()?> <?=getCurToPrice($intWishPrice)?></strong></td>
						<td class="checkBtn">
							<a href="javascript:goBasket(<?=$wishRow[PW_NO]?>);"><img src="/himg/product/A0001/<?=$S_SITE_LNG_PATH?>/btn_cart_list_baguni.gif"/></a>
							<a href="javascript:goWishDel(<?=$wishRow[PW_NO]?>);"><img src="/himg/product/A0001/<?=$S_SITE_LNG_PATH?>/btn_cart_list_del.gif"/></a>
						</td>
					</tr>
							<?
						}
