<div class="contentTop"><h2><?=$LNG_TRANS_CHAR["BW00104"] //페이지 디자인 설정?></h2></div>
...
<div class="tabImgWrap">
	...
	<a href="./?menuType=layout&mode=jsFileEdit" <?if(!$strPageDesign) { echo "class=''"; }?>>스크립트 설정</a>
</div>
...
<div class="tableForm mt20">
	<div class="designEditerWrap">
		<textarea name="css_edit" id="css_edit" class="designEditForm" data-textarea-tab-key-no-move><?include $cssFile?></textarea>
	</div>
	<div class="buttonWrap">
		<a class="btn_blue_big" href="javascript:goCssFileEditActEvent()" id="menu_auth_m" style="display:none"><strong><?=$LNG_TRANS_CHAR["CW00066"] //바로적용하기?></strong></a>
	</div>
</div>
