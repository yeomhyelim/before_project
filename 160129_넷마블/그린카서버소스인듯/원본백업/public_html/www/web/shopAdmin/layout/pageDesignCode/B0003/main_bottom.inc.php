...
<div id="bottomArea">
	<div id="bottomWrap">
		...
		<div class="shopInfo">
				상호:{{__쇼핑몰명__}}  <span></span>{{__사업장주소__}} <span>대표:</span>{{__대표자명__}} </br>
				
				사업자번호: {{__사업자번호__}} <span>통신판매업신고:</span>{{__통신판매업신고번호__}} <span>대표전화:</span> {{__대표전화번호__}} </br>
				<span>개인정보관리책임:</span> {{__관리책임자명__}}({{__관리책임자이메일__}})
				<p>Copyright ⓒ 2012 <strong>{{__쇼핑몰URL__}}</strong> All rights reserved.</p>
		</div>
		<div class="icoWrap">
