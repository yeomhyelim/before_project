...
//		var objConfig2 = goEumEditor2ConfigMake(2);
		...
		var strEditorText1 = objTarget.find('textarea[name=store_memo]').val();
...
//		goEumEditor2Ready(objConfig1, objConfig2);
	...
	// 수정
	function goSellerShopSiteModifyActEvent() {
...
//		var strEditorText2 = goEumEditor2Text(2);
		...
		// 내용 설정
		objTarget.find('textarea[name=store_memo]').val(strEditorText1);
//		objTarget.find('textarea[name=sc_text]').val(strEditorText2);

		// 수정
		goAct('shopSiteUpdate');
	}
