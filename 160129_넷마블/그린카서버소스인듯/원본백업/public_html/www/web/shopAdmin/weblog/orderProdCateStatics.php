<?
	if (is_array($aryOrderProdCateList)){
		for($i=0;$i<sizeof($aryOrderProdCateList);$i++){
			$strY .= STR_REPLACE(",","",getFormatPrice($aryOrderProdCateList[$i][CATE_PRICE],2,$S_ST_CUR)).",";
			$strX .= "'".$aryOrderProdCateList[$i][CATE_NAME]."',";
		}
...
<!--
	...
	function goExcelDownload() {
		...
		data['mode']				= "excel";
		data['act']					= "excelOrderProdCateStatics";
...
<div id="contentArea">
	<div class="contentTop">
		<h2><?=$LNG_TRANS_CHAR["EW00067"] //카테고리분석?></h2>
		<div class="clr"></div>
	</div>
		...
		<table>
			...
			<tr>
				<th>
					...
					<a href="javascript:goStaticOrderBy('cateNameDesc');"><font color="#ffffff">▲</font></a>
					<a href="javascript:goStaticOrderBy('cartNameAsc');"><font color="#ffffff">▼</font></a>
				</th>
				<th>
					<?=$LNG_TRANS_CHAR["EW00075"] //주문수?>
					<a href="javascript:goStaticOrderBy('orderCntDesc');"><font color="#ffffff">▲</font></a>
					<a href="javascript:goStaticOrderBy('orderCntAsc');"><font color="#ffffff">▼</font></a>
				</th>
				<th>
