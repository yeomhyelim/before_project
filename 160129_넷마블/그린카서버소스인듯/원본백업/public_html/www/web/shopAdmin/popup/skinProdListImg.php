...
//		$("#colorpicker").css('display','inline').fadeOut(1000);
	...
	function prodMoneyIconChange(no) {
		...
		$("input:[name=prod_print_type_icon_file]").val("icon_w_" + no + ".gif");
	}
...
//-->
	...
	<div class="layerPopWrap">
		...
		<div class="popBoxWrap">
			...
			<a href="./?menuType=popup&mode=skinProdListDesign&ic_code=<?=$intIC_CODE?>&ic_type=<?=$strIC_TYPE?>&subPageCode=<?=$strSubPageCode?>">디자인 선택</a>
			<a href="./?menuType=popup&mode=skinProdListImg&ic_code=<?=$intIC_CODE?>&ic_type=<?=$strIC_TYPE?>&subPageCode=<?=$strSubPageCode?>" style="margin-left:200px" class="selected">이미지 설정</a>
			</div>
					...
					<tr>
						<th class="pickerStyle">
							<div class="inBorderFFF">
								...
								<strong class="block2">
									<span class="on_off"><input type="checkbox" value="Y" name="prod_name_color"<?=($row[$ds.'_PROD_NAME_COLOR']=="Y")?" checked":""?> id="on_off"/></span>
								</strong>
					...
					<tr>
						<th class="pickerStyle">
							<div class="inBorderFFF">
								...
								<strong class="block2">
									<span class="on_off"><input type="checkbox" value="Y" name="prod_intro_color"<?=($row[$ds.'_PROD_INTRO_COLOR']=="Y")?" checked":""?> id="on_off"/></span>
								</strong>
						...
						<th>
							<div class="inBorderFFF" style="height:18px;padding-top:10px;">
								...
								<span id="iconImg">
								<? if($row[$ds.'_PROD_PRINT_TYPE_ICON_FILE']): ?>
								<img src="/shopAdmin/himg/common/<?=$row[$ds.'_PROD_PRINT_TYPE_ICON_FILE']?>">
								<? endif; ?>
								</span>
								<input type="hidden" value="<?=$row[$ds.'_PROD_PRINT_TYPE_ICON_FILE']?>" name="prod_print_type_icon_file"/>
					...
					<tr>
						<th class="pickerStyle">
							<div class="inBorderFFF">
								...
								<strong class="block2">
									<span class="on_off"><input type="checkbox" value="Y" name="prod_point_color"<?=($row[$ds.'_PROD_POINT_COLOR']=="Y")?" checked":""?> id="on_off"/></span>
								</strong>
						...
						<th class="vTop">
							<div class="inBorderFFF" style="height:18px;padding-top:10px;">
								...
								<span class="on_off"><input type="checkbox" value="Y" name="prod_over_image_use"<?=($row[$ds.'_PROD_OVER_IMAGE_USE']=="Y")?" checked":""?> id="on_off"/></span>
								</strong>
							</div><!-- inBorderFFF -->
						</th>
					</tr>
					<tr>
						<th class="pickerStyle">
							<div class="inBorderFFF">
								...
								<strong class="block2">
									<span class="on_off"><input type="checkbox" value="Y" name="prod_price_color"<?=($row[$ds.'_PROD_PRICE_COLOR']=="Y")?" checked":""?> id="on_off"/></span>
								</strong>
					...
					<tr>
						<th class="pickerStyle">
							<div class="inBorderFFF">
								...
								<strong class="block2">
									<span class="on_off"><input type="checkbox" value="Y" name="prod_sale_color"<?=($row[$ds.'_PROD_SALE_COLOR']=="Y")?" checked":""?> id="on_off"/></span>
								</strong>
