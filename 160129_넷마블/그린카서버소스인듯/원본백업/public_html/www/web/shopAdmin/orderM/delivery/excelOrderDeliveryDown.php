<table border="1">
	...
	<tr>
		...
		<td><?=""; //추가상품금액?></td>
		<td><?=""; //상품배송방법?></td>
		<td><?="__DELIVERY_COM__"; //배송회사?></td>
		<td><?="__DELIVERY_NUM__"; //송장번호?></td>
		<?if($S_MALL_TYPE!="R"){?><td><?=""; //총배송비?></td><?}?>
		<td><?=""; //배송상태?></td>
		<td><?=""; //구매상태?></td>
		<td><?=""; //관리자메모?></td>
	...
	<tr>
		...
		<td><?=$row['O_APPR_DT']?></td>
		<?if($S_MALL_TYPE!="R"){?><td><?=$aryOrderCartShopList[$aryOrderCartList[$i]['P_SHOP_NO']]['ST_NAME']?></td><?}?>
