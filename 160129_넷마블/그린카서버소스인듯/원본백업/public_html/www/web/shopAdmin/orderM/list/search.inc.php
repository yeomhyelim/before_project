...
<div class="searchFormWrap">
	<select name="searchField" id="searchField">
		...
		<option value="deliveryNum"	<?if($_REQUEST["searchField"]=="deliveryNum"){echo " selected";}?>><?="배송번호"; //배송번호?></option>
		<option value="orderName"	<?if($_REQUEST["searchField"]=="orderName")	{echo " selected";}?>><?=$LNG_TRANS_CHAR["OW00003"] //주문자?></option>
		<option value="orderHp"	<?if($_REQUEST["searchField"]=="orderHp"){echo " selected";}?>><?="주문자핸드폰" //주문자핸드폰?></option>
		<option value="orderIdMail"	<?if($_REQUEST["searchField"]=="orderIdMail"){echo " selected";}?>><?="주문자메일" //주문자메일?></option>
