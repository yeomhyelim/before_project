...
<!--
	function goAct(){
		...
		C_getAction("poproomTypeSetModify","<?=$PHP_SELF?>");
	}
//-->
</script>
<style type="text/css">
...
<input type="hidden" name="no" value="<?=$intNo?>">
         <table class="tableForm">
            <tr>
                <th><span>순서</span></th>
                <td>
                    <input id="am_ranking2" name="am_ranking2" type="text" value="<?echo $row['AM_ORDER']?>">
                </td>
            </tr>
           <tr>
                <th><span>객실유형</span></th>
                <td>
                    <input id="am_name2" name="am_name2" type="text" value="<?echo $row['AM_DEV']?>">
                </td>
            </tr>
        </table>
</form>
