...
<form name="form" id="form" method="post">
	...
	<div class="buttonWrap">
		<a class="btn_blue_big" href="javascript:goOrderCancelAct();" id="menu_auth_w"><strong><?=$LNG_TRANS_CHAR["CW00079"] //확인?></strong></a>
...
<input type="text" name="ver" id="ver" value="140">
<input type="text" name="mid" id="mid" value="<?=$S_EXIMBAY_MID?>">
<input type="text" name="txntype" id="txntype" value="VOID">
<input type="text" name="ref" value="<?=$row['O_KEY']?>"> <!--mandatory-->
<input type="text" name="cur" value="<?=$strForSettleCur?>">
<input type="text" name="amt" value="<?=$row['O_TOT_SPRICE']?>">
<input type="text" name="voidamt" value="<?=$row['O_TOT_SPRICE']?>">
<input type="text" name="transid" value="<?=$row['O_APPR_NO']?>">
<input type="text" name="reason" value="">
<input type="text" name="lang" value="<?=$strForSettleLang?>"> <!--mandatory-->
<input type="text" name="returnurl" id="returnurl" value="<?=$S_SITE_URL?>/common/eximbay/cancelReturn.php">
<input type="text" name="param1" id="param1" value="<?=$intO_NO?>">
<input type="text" name="param2" id="param2" value="">
<input type="text" name="param3" id="param3" value="<?=$S_SITE_LNG?>_A">
<input type="text" name="fgkey" value="<?=$strEximbayFgKey?>">
