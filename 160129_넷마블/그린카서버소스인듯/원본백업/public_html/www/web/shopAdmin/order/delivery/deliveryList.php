<?
	## 타이틀 설정
	if($strSearchOrderStatus=="UI"):
		$strTitle = $LNG_TRANS_CHAR["OW00093"];
	elseif($strSearchOrderStatus=="B"):
		$strTitle = $LNG_TRANS_CHAR["OW00122"];
	elseif($strSearchOrderStatus=="I"):
		$strTitle = $LNG_TRANS_CHAR["OW00123"];
	elseif($strSearchOrderStatus=="D"):
		$strTitle = $LNG_TRANS_CHAR["OW00124"];
	else:
		$strTitle = $LNG_TRANS_CHAR["OW00121"];
	endif;
?>
...
<div id="contentArea">
			...
			<tr>
				...
				<td>
					...
					<span class="searchWrapImg">
						...
						<a href="#" class="btn_sml"><strong><?=$LNG_TRANS_CHAR["CW00022"]?></strong></a>
					</span>
				</td>
			</tr>
			<tr>
	...
	<div class="tableList">
		<table style="border-left:1px solid #D2D0D0">
			...
			<tr>
				...
				<td>
					<?=$aryDeliveryComAll[$row[O_DELIVERY_COM]]?>
				</td>
				<td>
					<?=$row[O_DELIVERY_NUM]?>
	...
	<div class="buttonBoxWrap">
		<select id="orderDeliveryStatus" name="orderDeliveryStatus">
