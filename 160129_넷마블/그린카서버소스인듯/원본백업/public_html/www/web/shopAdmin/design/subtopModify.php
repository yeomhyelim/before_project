...
//]]>
	...
	<input type="hidden" name="ti_top_image_bak" value="<?= $row[TI_TOP_IMAGE] ?>" />
	<input type="hidden" name="ti_left_image_bak" value="<?= $row[TI_LEFT_IMAGE] ?>" />
	...
	<div class="tableForm">
		<table>
			...
			<tr>
				...
				<td>
					...
					<?
						if($row[TI_TOP_IMAGE]) :
							echo "<img src='../upload/subtopimg/".$row[TI_TOP_IMAGE]." 'style='width:200px;height:50px;'/>";
						endif;
					?>					
					</div>
				</td>
			...
			<tr>
				...
				<td>
					...
					<div class="attachImg">
					<?
						if($row[TI_LEFT_IMAGE]) :
							echo "<img src='../upload/subtopimg/".$row[TI_LEFT_IMAGE]." 'style='width:200px;height:50px;'/>";
						endif;
					?>					
					</div>					
				</td>
			...
			<tr>
				<th>HTML</th>
				<td><textarea name="ti_html_top" id="ti_html_top" title="higheditor_full" style="width:100%;height:200px;"><?= $row[TI_HTML_TOP] ?></textarea></td>
			</tr>
			<!-- tr>
				<th>하단 HTML</th>
		...
		<div class="buttonWrap">
			<a class="btn_blue_big" href="javascript:goSubtopAct('subtopModify');" id="menu_auth_m"><strong>설정 저장</strong></a>
		</div>
	</div>
