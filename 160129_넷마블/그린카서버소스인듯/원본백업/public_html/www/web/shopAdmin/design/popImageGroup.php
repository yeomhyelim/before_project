<?
	...
	$intTotal 					= $designMgr->getDesignMgrTotal($db);
	...
	$result 						= $designMgr->getDesignMgrList($db);
				...
				<tr>
					...
					<td style="text-align:left;">
						<ul class="sampleWrap">
							...
							<li><img src="http://eumshop.co.kr/himg/design/<?=$row[DM_SAMPLE_IMAGE_1]?>"/></li>
							<li>
								<?=$row[DM_DESIGN_TXT]?>
							</li>
						</ul>
