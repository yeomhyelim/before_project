...
<div class="buttonBoxWrap">
	<a class="btn_new_blue" href="javascript:postMailTestSendActClickEvent()" id="menu_auth_m"><strong>보내기</strong></a>
	<? if($strTarget == "pop") : // 팝업인경우 ?>
		<a class="btn_new_gray" href="javascript:postMailCloseClickEvent()"><strong class="ico_cancel">닫기</strong></a>
	<? else : // 일반 ?>
