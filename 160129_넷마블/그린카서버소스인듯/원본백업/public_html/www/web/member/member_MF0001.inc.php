				...
				<div class="memberLogin mt50">
					...
					<div class="loginForm mt10">
						<table>		
							<tr>
								<th>성명</th>
								<td style="text-align:left;"><input type="input" name="searchId_Name" id="searchId_Name" style="width:100px;"/></td>
				...
				<div class="memberLogin mt50">
					...
					<table>
						...
						<tr>
							<th>성명</th>
							<td style="text-align:left;">
								<input type="input" name="searchPass_Name" id="searchPass_Name"  style="width:100px;"/>
							</td>
						</tr>
						<tr id="searchPwd">
							<th>이메일</th>
