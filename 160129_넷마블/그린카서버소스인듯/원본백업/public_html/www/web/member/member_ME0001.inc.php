<?php
	...
	## 소스 위치가 변경됨..
	## /home/shop_eng/www/web/member/include/memberJoinEnd.skin.inc.php
	...
	if(!$strM_F_NAME) { $strFullName = "{$strFullName} {$strM_F_NAME}"; }
...
?>
		...
		<div class="joinWrap mt20">
			<!-- (1) 기본정보 입력  -->
				<h4><img src="/himg/member/A0001/<?=$S_SITE_LNG_PATH?>/tit_mem_reg_1.gif"/></h4>
				<span class="txtInfo">  <?=callLangTrans($LNG_TRANS_CHAR["MS00019"],array($strFullNameHtml))?> <!--<?=$row[M_NAME]?>님의 회원가입이 완료 되었습니다.//--></span>
				<div class="regWrap">
					<table>
						<colgroup>
							...
							<td>
								...
								<?if ($S_JOIN_SMSYN["USE"] == "Y" && $S_JOIN_SMSYN["JOIN"] == "Y"){?>
									<?if (!$S_JOIN_SMSYN["GRADE"] || in_array($strMemberJoinType,$S_JOIN_SMSYN["GRADE"])){?>
										<span  class="txt_Minfo"><?=($row[M_SMSYN]=="Y")?$LNG_TRANS_CHAR["MS00007"]:"";?> </span>
									<?}?>
								<?}?>
							</td>
						</tr>
							...
							<td>
								...
								<?if ($S_JOIN_MAILYN["USE"] == "Y" && $S_JOIN_MAILYN["JOIN"] == "Y"){?>
									<?if (!$S_JOIN_MAILYN["GRADE"] || in_array($strMemberJoinType,$S_JOIN_MAILYN["GRADE"])){?>
										<span class="txt_Minfo"><?=($row[M_MAILYN]=="Y")?$LNG_TRANS_CHAR["MS00008"]:"";?> </span>
									<?}?>
								<?}?>
							</td>
						</tr>
				...
				<h4 class="mt30"><img src="/himg/member/A0001/<?=$S_SITE_LNG_PATH?>/tit_mem_reg_3.gif"/></h4>
				<div class="regWrap">
					<table>
						<colgroup>
							<col style="width:110px;"/>
		...
		<div class="btnCenter mt30">
			<a href="./"><img src="/himg/member/A0001/<?=$S_SITE_LNG_PATH?>/btn_reg_ok.gif"/></a>
			<a href="./?menuType=member&mode=login"><img src="/himg/member/A0001/<?=$S_SITE_LNG_PATH?>/btn_mypage_go.gif"/></a>
		</div>