<?php
	/**
	 * eumshop app - communityList - dataSpecReviewSkin
	 *
	 * 커뮤니티 리스트를 불러옵니다.
	 *
	 ...
	 * @since		Version 1.0
	 * @filesource	/public_html/www/web/app/communityList/communityList.dataSpecReviewSkin.php
	 * @manual		menuType=app&mode=communityList&skin=dataSpecReviewSkin
	 * @history
	 *				2014.11.18 kim hee sung - 개발 완료
	 */
...
?>
<!-- eumshop app - communityList - dataSpecReviewSkin (<?php echo $strAppID?>) -->
<div id="<?php echo $strAppID?>">
	...
	<div class="specListWrap">
		<div class="specList">
				...
				<?php if(!$intAppTotal):?>
				<div>
					<?php $LNG_TRANS_CHAR["MS00101"]; // 등록된 내용이 업습니다.?>
				</div>
				<?php else:?>
...
//						$aryFunc[] = $strUB_FUNC[9]; // 대기
				...
				<div class="listBox">
					<ul>
						...
						<li class="grade"><?php if($isPGrade):?>
							<img src="/himg/board/icon/icon_star_<?php echo $intUB_P_GRADE;?>.png"/>
							<?php endif;?>
						</li>
						<?php endif;?>
						<?php if(in_array("등록일", $aryAppColumn)):?>
						<li class="date"><?php echo $strUB_REG_DT;?></li>
						<?php endif;?>
						<?php if(in_array("제목", $aryAppColumn)):?>
						<li class="title"><?php echo $strAnsHtml;?><?php echo $strUB_TITLE;?><?php echo $strLockHtml;?></li>
						<?php endif;?>					
						<li class="userImg"><img src="/himg/community/comment/img_user.jpg" alt="프로필 사진" class="userImg"></li>
						<li class="comt">글내용</li>					
					</ul>
					<div class="clr"></div>
				</div>
